                ...
                <div class="post-container">
                    <?php
                        ...
                        if(isset($_GET['search']) && $_GET['search'] != ""){
                            $search = $_GET['search'];
                            echo '<h2 class="page-heading">Results for: "'.$search.'"</h2>';
                    ...
                    <?php
                                ...
                                echo "<div class='text-center my-3'>
                                    <h1 class='text-muted'>No post to show!</h1>
                                </div>";
                            }
                    ?>
                        ...
                        <nav aria-label="Page navigation example">
                            ...
                            <?php                            
                                ...
                                if(mysqli_num_rows($result1) > 0){
                                    if($page > 1){
                                        echo '<li class="page-item"><a class="page-link" href="search.php?search='.$search.'&page='.($page-1).'">
                            ...
                            ?>  
                                    <li class="page-item <?php echo $active; ?>">
                                        <a class="page-link" href="search.php?search=<?php echo $search; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                    </li>
                            <?php
                                    }
                                    if($total_pages > $page){
