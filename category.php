        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">                
                    <h2 class="page-heading">Category:</h2>
                    <?php
                        $limit = 4;
                    ...
                    <?php
                        ...
                        }else{ header("Location: {$hostname}/index.php"); }
                    ?>
                            ...
                            <nav aria-label="Page navigation example">
                                ...
                                <?php                            
                                    ...
                                    if(mysqli_num_rows($result1) > 0){
                                        if($page > 1){
                                            echo '<li class="page-item"><a class="page-link" href="category.php?cat='.$catid.'&page='.($page-1).'">
                                ...
                                ?>  
                                        <li class="page-item <?php echo $active; ?>">
                                            <a class="page-link" href="category.php?cat=<?php echo $catid; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                        </li>
                                <?php
                                        }
                                        if($total_pages > $page){
